import{r as v}from"./index-DEQ1fQa5.js";import{a as C,g as b,c as k,e as w}from"./createTheme-CJfKwWVs.js";import{u as x,s as R,c as S,m as $}from"./DefaultPropsProvider-C3iF_79r.js";import{j as U}from"./jsx-runtime-Dhli7KBL.js";import{a as u,k as c}from"./createSimplePaletteValueFilter-DcXnBabR.js";function M(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function A(t){return parseFloat(t)}function X(t){return C("MuiSkeleton",t)}b("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const j=t=>{const{classes:e,variant:a,animation:n,hasChildren:o,width:i,height:s}=t;return S({root:["root",a,n,o&&"withChildren",o&&!i&&"fitContent",o&&!s&&"heightAuto"]},X,e)},r=c`
  0% {
    opacity: 1;
  }
